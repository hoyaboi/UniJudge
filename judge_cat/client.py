"""
Minimal LLM client for cat judge (OpenAI only).
Same interface and behavior as cat project model clients.
"""
import os
...
class OpenAIClient(LLMClient):
    """OpenAI API client (same as cat model/clients/openai.py)."""
...
def get_judge_client(model_name: Optional[str] = None) -> LLMClient:
    ...
    Default model: gpt-4o-mini. Same behavior as cat ModelFactory.create_judge_llm().
    """
