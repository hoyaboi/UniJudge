"""
Minimal LLM client for crescendo judge (OpenAI only).
...
class OpenAIClient(LLMClient):
    """OpenAI API client (same as judge_cat model/clients/openai.py)."""
...
def get_judge_client(model_name: Optional[str] = None) -> LLMClient:
    ...
    Default model: gpt-4o-mini. Same behavior as judge_cat ModelFactory.create_judge_llm().
    """
